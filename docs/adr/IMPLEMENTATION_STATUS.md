...
| 0078 | The uncarried emotions: a location survey | **Survey accepted** (owner request, 2026-09-04); D210 recognition partly wired; D211 wired inert; remaining entries open | **Partly wired** — D210 gratitude recognition and D211 grief carrier/folds are terminal-only and inert by default; grief thresholds and magnitudes await measurement |
