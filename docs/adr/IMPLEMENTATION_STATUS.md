...
| 0071 | Captivity and the exchange: being taken is being held | **Accepted** for D177/D181/D183; seminar-only wiring dated 2026-08-30. The exact ruling is “Pieces first get paid during the draft”; terminal exchange hope is now folded in the seminar path. D182 magnitude/registration, D178–D180, D184, and D185 remain open | **Partly wired** — seminar pool folding enables the opt-in captive hold, persistent piece cash, pre-draft ransom, captor credit, inert-by-default benevolence decay, and terminal exchange-hope incidents. Campaign and season callers do not pass captivity metadata and remain unchanged; unransomed captives never enter draft lots. |
...
| 0078 | The uncarried emotions: a location survey | **Survey accepted** (owner request, 2026-09-04); D210 recognition partly wired; D211 and D212 wired inert; remaining entries open | **Partly wired** — D210 gratitude recognition, D211 grief carrier/folds, and D212 shame reading are terminal-only and inert by default; shame names positive unvindicated override exposures with both scale knobs at zero, and grief/shame thresholds and magnitudes await measurement |
