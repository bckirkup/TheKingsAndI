...
| 0078 | The uncarried emotions: a location survey | **D210 partly wired — gratitude recognition fold**; D208–D209 and D211–D217 remain open | **Partly wired — gratitude recognition fold** in the terminal seminar path; ransom is the only active trigger, with honor/void/owed naming; costly-signal recognition and pricing remain open |
