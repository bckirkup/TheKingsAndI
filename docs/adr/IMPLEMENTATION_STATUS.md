...
| 0055 | Earned ability from vindicated judgment | Direction resolved; calibrated magnitude remains open | **Wired at zero magnitude** — `src/psychology/reducers.ts:65-108`, `src/orchestration/psychologyHooks.ts:270-285`, `sim/pool.ts:252-277`, and campaign spread metrics |
