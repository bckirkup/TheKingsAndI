...
| `docs/adr/0066-the-floor-under-the-curdle.md` | **D167 ruled, partly live:** the witness broadcast stays (being rough on one piece curdles the room), the proportional cliff is live at its D166 magnitude, and witness grading remains unresolved under D174. The rupture-debt ceiling remains inert under the repair-versus-accrual constraint, and D175 records the deep-tail gap where proportional charging can stall at low benevolence. D170 (status-priced overrides) is deliberately left open |
