...
| `docs/adr/0078-the-uncarried-emotions.md` | **D208 and D212 wired inert; D210 recognition is partly wired; D211 grief is wired inert; D209 and D213–D217 remain open.** Bitterness is an optional terminal-only carrier with rupture-floor and captive-decay recognition, inert repair/regard/morning-lift discounts, and match-boundary decay. Grief carries clamped deterministic mourning and terminal naming only. Shame is a terminal-only, default-inert reading that reuses ADR 0070 witnesses and scales only the target's own unvindicated-override loss. Gratitude remains a terminal-only ransom recognition fold; thresholds, magnitudes, and pricing remain open |
