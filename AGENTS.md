...
| `docs/adr/0078-the-uncarried-emotions.md` | **D210 partly wired (recognition); D208–D209 and D211–D217 remain open.** Gratitude is a terminal-only ransom recognition fold: commander/split payment forms, positive-margin courage honors, unvindicated override voids, and unresolved debts are owed; costly-signal recognition, refusal-threshold credit, and pricing remain open. The self-sprung negation stays in exchange hope |
